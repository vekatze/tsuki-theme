...
(tsuki-theme--define-theme tsuki
  ...
  ((all-the-icons-blue (:foreground mid-blue))
   ...
   (all-the-icons-dcyan (:foreground mid-blue))
   (all-the-icons-dgreen (:foreground mid-green))
   (all-the-icons-dired-dir-face (:inherit 'dired-directory))
   (all-the-icons-dmaroon (:foreground mid-orange))
   (all-the-icons-dorange (:foreground mid-orange))
   (all-the-icons-dpink (:foreground mid-magenta))
   (all-the-icons-dpurple (:foreground mid-magenta))
   (all-the-icons-dred (:foreground mid-magenta))
   (all-the-icons-dsilver (:foreground gray))
   (all-the-icons-dyellow (:foreground mid-orange))
   (all-the-icons-green (:foreground mid-green))
   (all-the-icons-lblue (:foreground mid-blue))
   (all-the-icons-lcyan (:foreground mid-blue))
   (all-the-icons-lgreen (:foreground mid-green))
   (all-the-icons-lmaroon (:foreground mid-orange))
   (all-the-icons-lorange (:foreground mid-orange))
   (all-the-icons-lpink (:foreground mid-magenta))
   (all-the-icons-lpurple (:foreground mid-magenta))
   (all-the-icons-lred (:foreground mid-magenta))
   (all-the-icons-lsilver (:foreground gray))
   (all-the-icons-lyellow (:foreground mid-orange))
   (all-the-icons-maroon (:foreground mid-orange))
   (all-the-icons-orange (:foreground mid-orange))
   (all-the-icons-pink (:foreground mid-magenta))
   (all-the-icons-purple (:foreground mid-magenta))
   (all-the-icons-purple-alt (:foreground mid-magenta))
   (all-the-icons-red (:foreground mid-magenta))
   (all-the-icons-red-alt (:foreground mid-magenta))
   (all-the-icons-silver (:foreground gray))
   ...
   (fancy-compilation-complete-error-face (:background dark-red :foreground mid-red :extend t))
   (fancy-compilation-complete-success-face (:background dark-green :foreground mid-green :extend t))
   (fancy-compilation-default-face (:inherit 'default))
   ...
   (info-title-1 (:inherit 'info-title-2))
   (info-title-2 (:inherit 'info-title-3))
   (info-title-3 (:inherit 'info-title-4))
   (info-title-4 (:weight 'bold :inherit font-lock-keyword-face))
   ...
   (magit-diff-added (:foreground mid-green :background dark-green))
   ...
   (magit-diff-removed (:foreground mid-red :background dark-red))
   ...
   (markdown-code-face (:background dark-blue :extend t))
   ...
   (org-block-begin-line (:foreground nibi :background dark-blue :extend t))
   (org-block-end-line (:foreground nibi :background dark-blue :extend t))
   ...
   (org-headline-done (:foreground mid-green))
   ...
   (org-todo (:foreground light-magenta :background dark-magenta))
   ...
   (ruri-checker-error (:foreground mid-red :background dark-red))
   (ruri-checker-info (:foreground mid-green :background dark-green))
   (ruri-checker-warning (:foreground mid-orange :background dark-orange))
   ...
   (warning (:weight 'bold :foreground mid-orange :background dark-orange))
