...
(tsuki-theme--define-theme tsuki
  ...
  ((ansi-color-black (:foreground black :background black))
   ...
   (whitespace-empty (:extend t :foreground red-mid :background green))
   (whitespace-hspace (:foreground gray :background black))
   (whitespace-indentation (:foreground red-mid :background green))
   ...
   (whitespace-space-after-tab (:foreground red-mid :background green))
   (whitespace-space-before-tab (:foreground red-mid :background orange))
