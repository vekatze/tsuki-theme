...
(tsuki-theme--define-theme tsuki
  ...
  ((ansi-color-black (:foreground black :background black))
   ...
   (ansi-color-bright-red (:foreground red-mid :background red-mid))
   ...
   (ansi-color-red (:foreground red-mid :background red-mid))
   ...
   (error (:weight 'bold :foreground red-mid :background red-dark))
   ...
   (flycheck-error (:background red-dark :underline (:style 'wave :color red-mid)))
   (flycheck-fringe-error (:foreground red-mid :background red-dark))
   ...
   (isearch (:foreground red-mid :background red-dark))
   ...
   (ruri-flycheck-error (:foreground red-mid :background red-dark))
   ...
   (show-paren-mismatch (:foreground red-mid :background red-dark :underline t))
   ...
   (trailing-whitespace (:background red-mid))
   ...
   (whitespace-big-indent (:foreground red-mid :background red-light))
   (whitespace-empty (:extend t :foreground red-mid :background green-mid))
   (whitespace-hspace (:foreground gray :background black))
   (whitespace-indentation (:foreground red-mid :background green-mid))
   ...
   (whitespace-space-after-tab (:foreground red-mid :background green-mid))
   (whitespace-space-before-tab (:foreground red-mid :background orange-mid))
   (whitespace-tab (:foreground gray :background black))
   (whitespace-trailing (:foreground red-mid :background red-dark))
