...
(let* ((white (tsuki-theme-get-color 'white tsuki-theme-palette))
       ...
       (wakaba (tsuki-theme-get-color 'wakaba tsuki-theme-palette))
       ...
       (mid-yellow (tsuki-theme-get-color 'mid-yellow tsuki-theme-palette))
  ...
  (custom-theme-set-faces
   ...
   `(ansi-color-bright-yellow ((t (:foreground ,mid-yellow :background ,mid-yellow))))
   ...
   `(ansi-color-yellow ((t (:foreground ,mid-yellow :background ,mid-yellow))))
   `(bookmark-face ((t (:foreground ,mid-orange))))
   `(change-log-date ((t (:foreground ,kuchiba :inherit default))))
   `(change-log-name ((t (:foreground ,wakaba :inherit default))))
   ...
   `(diff-hl-change ((t (:foreground ,mid-magenta :background ,mid-magenta))))
   `(diff-hl-delete ((t (:foreground ,mid-red :background ,mid-red))))
   `(diff-hl-insert ((t (:foreground ,mid-green :background ,mid-green))))
   ...
   `(eww-form-checkbox ((t (:box (:color ,mid-blue :line-width 1)))))
   `(eww-form-file ((t (:box (:color ,mid-blue :line-width 1)))))
   `(eww-form-select ((t (:box (:color ,mid-blue :line-width 1)))))
   `(eww-form-submit ((t (:box (:color ,mid-blue :line-width 1)))))
   `(eww-form-text ((t (:box (:color ,mid-blue :line-width 1)))))
   ...
   `(flycheck-verify-select-checker ((t (:box (:color ,mid-blue :line-width 1)))))
   ...
   `(magit-blame-heading ((t (:foreground ,nibi :background ,dark-blue))))
   ...
   `(tool-bar ((t (:foreground ,white :background ,black))))
