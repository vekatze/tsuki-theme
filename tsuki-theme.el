...
(tsuki-theme--define-theme tsuki
  ...
  ((ansi-color-black (:foreground black :background black))
   ...
   (ansi-color-bright-green (:foreground green-mid :background green-mid))
   (ansi-color-bright-magenta (:foreground magenta-mid :background magenta-mid))
   (ansi-color-bright-red (:foreground red-accent :background red-accent))
   (ansi-color-bright-white (:foreground white :background white))
   (ansi-color-bright-yellow (:foreground green-mid :background green-mid))
   (ansi-color-cyan (:foreground blue-mid :background blue-mid))
   (ansi-color-fast-blink (:box (:line-width -1)))
   (ansi-color-inverse (:inverse-video t))
   (ansi-color-magenta (:foreground magenta-mid :background magenta-mid))
   (ansi-color-red (:foreground red-accent :background red-accent))
   (ansi-color-slow-blink (:box (:line-width -1)))
   (ansi-color-white (:foreground white :background white))
   (ansi-color-yellow (:foreground green-mid :background green-mid))
   (bookmark-face (:foreground orange-mid))
   (completions-common-part (:foreground blue-light))
   (consult-separator (:foreground black))
   (corfu-bar (:background gray))
   (corfu-border (:background blue-mid))
   (corfu-current (:foreground white :background tsuki))
   (corfu-default (:background black))
   (cursor (:foreground blue-mid :background blue-mid))
   (custom-button (:foreground magenta-light :background magenta-dark :box (:color magenta-mid :line-width 1)))
   ...
   (custom-state (:foreground green-mid))
   ...
   (diary (:foreground green-mid))
   (diff-added (:foreground green-light :background green-dark))
   (diff-changed (:foreground magenta-light :background magenta-dark))
   ...
   (diff-header (:foreground blue-mid :background blue-dark))
   ...
   (diff-refine-changed (:background green-mid))
   (diff-removed (:foreground red-light :background red-dark))
   ...
   (epa-mark (:weight 'bold :foreground orange-mid))
   ...
   (error (:weight 'bold :foreground red-accent :background red-dark))
   ...
   (eww-valid-certificate (:weight 'bold :foreground green-dark))
   (flycheck-error (:background red-dark :underline (:style 'wave :color red-accent)))
   (flycheck-fringe-error (:foreground red-accent :background red-dark))
   (flycheck-fringe-info (:foreground green-mid :background green-dark))
   (flycheck-fringe-warning (:foreground magenta-mid :background magenta-dark))
   ...
   (flycheck-posframe-border-face (:foreground blue-mid))
   (flycheck-posframe-face (:foreground blue-mid))
   ...
   (font-lock-doc-face (:foreground green-mid :background green-dark))
   (font-lock-function-name-face (:foreground magenta-light :background magenta-dark))
   (font-lock-keyword-face (:foreground blue-mid :background blue-dark))
   (font-lock-preprocessor-face (:foreground orange-mid :background orange-dark))
   (font-lock-string-face (:foreground orange-mid :background orange-dark))
   ...
   (gnus-emphasis-highlight-words (:foreground green-mid :background black))
   ...
   (gnus-group-news-low-empty (:foreground blue-mid))
   (gnus-splash (:foreground white))
   (gnus-summary-cancelled (:extend t :foreground green-mid :background black))
   (gnus-summary-normal-ancient (:extend t :foreground blue-mid))
   (gnus-summary-normal-read (:extend t :foreground green-mid))
   ...
   (ido-indicator (:width 'condensed :foreground green-mid :background red-light))
   (ido-only-match (:foreground green-dark))
   ...
   (lazy-highlight (:foreground green-light :background green-dark))
   ...
   (log-view-message (:background magenta-dark :foreground magenta-mid))
   (lsp-installation-buffer-face (:foreground green-mid))
   (lsp-installation-finished-buffer-face (:foreground orange-mid))
   (lsp-ui-doc-background (:background black))
   (lsp-ui-doc-header (:foreground black :background blue-mid))
   (lsp-ui-peek-filename (:foreground orange-mid))
   ...
   (magit-header-line (:foreground blue-light :background tsuki :box (:color blue-mid :line-width 1)))
   ...
   (markdown-highlighting-face (:foreground black :background green-mid))
   (match (:inherit 'highlight))
   (mc/cursor-bar-face (:height 1 :background blue-mid))
   (mc/cursor-face (:inverse-video t))
   (menu (:inverse-video t))
   (message-cited-text-1 (:foreground orange-light))
   (message-cited-text-2 (:foreground green-dark))
   (message-cited-text-3 (:foreground orange-mid))
   (message-cited-text-4 (:foreground orange-mid))
   (message-header-cc (:weight 'bold :foreground green-mid))
   (message-header-name (:foreground green-mid))
   (message-header-newsgroups (:weight 'bold :slant 'italic :foreground green-mid))
   (message-header-other (:foreground red-light))
   (message-header-subject (:foreground green-mid))
   (message-header-to (:weight 'bold :foreground green-mid))
   (message-header-xheader (:foreground blue-mid))
   (message-mml (:foreground green-mid))
   ...
   (mm-command-output (:foreground green-dark))
   (mm-uu-extract (:extend t :foreground white :background green-dark))
   (mode-line (:foreground blue-mid :background tsuki :box (:color blue-mid :line-width 1)))
   (mode-line-active (:inherit 'mode-line))
   (mode-line-highlight (:background blue-mid))
   (mode-line-inactive (:foreground blue-mid :background blue-dark :box (:color blue-mid :line-width 1)))
   ...
   (orderless-match-face-0 (:weight 'bold :foreground blue-mid))
   (orderless-match-face-1 (:weight 'bold :foreground magenta-light))
   (orderless-match-face-2 (:weight 'bold :foreground green-mid))
   (orderless-match-face-3 (:weight 'bold :foreground orange-light))
   (org-agenda-dimmed-todo-face (:foreground gray))
   (org-agenda-done (:foreground green-mid))
   (org-agenda-restriction-lock (:background black))
   (org-agenda-structure (:foreground blue-mid))
   (org-block (:background black-tinted :extend t))
   (org-block-begin-line (:foreground blue-mid :background blue-dark :extend t))
   (org-block-end-line (:foreground blue-mid :background blue-dark :extend t))
   ...
   (org-done (:weight 'bold :foreground green-mid))
   (org-drawer (:foreground blue-mid))
   (org-ellipsis (:underline t :foreground green-light))
   (org-footnote (:underline t :foreground blue-light))
   (org-formula (:foreground orange-mid))
   (org-headline-done (:foreground orange-mid))
   (org-headline-todo (:foreground magenta-light))
   (org-hide (:foreground black))
   (org-latex-and-related (:foreground orange-light))
   (org-scheduled (:foreground green-mid))
   (org-scheduled-previously (:foreground orange-mid))
   (org-scheduled-today (:foreground green-mid))
   (org-sexp-date (:foreground blue-light))
   (org-table (:foreground blue-mid))
   (org-time-grid (:foreground green-light))
   (org-todo (:weight 'bold :foreground orange-light))
   (org-upcoming-deadline (:foreground orange-mid))
   ...
   (pulse-highlight-face (:extend nil :background green-mid))
   (pulse-highlight-start-face (:background green-mid))
   (region (:background tsuki :extend t))
   (ruri-flycheck-error (:foreground red-accent :background red-dark))
   (ruri-flycheck-info (:foreground green-mid :background green-dark))
   (ruri-flycheck-warning (:foreground orange-mid :background orange-dark))
   ...
   (show-paren-match (:foreground green-mid :background green-dark :underline t))
   (show-paren-mismatch (:foreground red-accent :background red-dark :underline t))
   (shr-mark (:foreground black :background green-mid))
   (shr-strike-through (:strike-through t))
   (shr-sup (:height 0.8))
   (smerge-base (:extend t :background green-dark))
   ...
   (success (:foreground green-mid :background green-dark))
   ...
   (tooltip (:foreground white :background blue-dark :box (:color blue-mid :line-width 1)))
   (trailing-whitespace (:background red-accent))
   (transient-disabled-suffix (:weight 'bold :foreground black :background red-light))
   (transient-enabled-suffix (:weight 'bold :foreground black :background green-mid))
   ...
   (tty-menu-enabled-face (:weight 'bold :foreground green-mid :background tsuki))
   (tty-menu-selected-face (:background red-light))
   (vertical-border (:foreground blue-mid))
   (vundo-default (:foreground gray))
   (vundo-highlight (:foreground green-light :background green-dark :inherit 'vundo-default))
   (warning (:foreground orange-mid :background orange-dark))
   (which-func (:foreground blue-dark))
   (whitespace-big-indent (:foreground red-accent :background red-light))
   (whitespace-empty (:extend t :foreground red-accent :background green-mid))
   (whitespace-hspace (:foreground gray :background black))
   (whitespace-indentation (:foreground red-accent :background green-mid))
   (whitespace-line (:foreground magenta-mid :background black))
   (whitespace-missing-newline-at-eof (:foreground black :background green-mid))
   (whitespace-newline (:weight 'normal :foreground gray))
   (whitespace-space (:foreground gray :background black))
   (whitespace-space-after-tab (:foreground red-accent :background green-mid))
   (whitespace-space-before-tab (:foreground red-accent :background orange-mid))
   (whitespace-tab (:foreground gray :background black))
   (whitespace-trailing (:foreground red-accent :background red-dark))
   (widget-button-pressed (:foreground red-light))
   (widget-documentation (:foreground green-mid))
   (widget-field (:extend t :box (:line-width 1 :color gray) :background gray))
   (widget-single-line-field (:background gray))
   (window-divider (:foreground blue-mid))
   (window-divider-first-pixel (:foreground blue-mid))
   (window-divider-last-pixel (:foreground blue-mid))))
