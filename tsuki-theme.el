...
(tsuki-theme--define-theme tsuki
  ...
  ((ansi-color-black (:foreground black :background black))
   ...
   (lazy-highlight (:background tsuki))
   ...
   (magit-header-line (:foreground blue-light :background tsuki :box (:color blue :line-width 1)))
   ...
   (mode-line (:foreground blue :background tsuki :box (:color blue :line-width 1)))
   ...
   (tty-menu-enabled-face (:weight 'bold :foreground green :background tsuki))
   ...
   (whitespace-empty (:extend t :foreground red-accent :background green))
   (whitespace-hspace (:foreground gray :background black))
   (whitespace-indentation (:foreground red-accent :background green))
   ...
   (whitespace-space-after-tab (:foreground red-accent :background green))
   (whitespace-space-before-tab (:foreground red-accent :background orange))
